        ...
        <div class="dialog-thumb__content">
            ...
            <div class="dialog-thumb__footer">
                ...
                <div class="dialog-thumb__actions">
                    <Badge v-if="has3dModel" value="3D" severity="contrast" class="dialog-thumb__badge-3d" />
                    <Button label="EDIT >" size="small" severity="warning" outlined class="dialog-thumb__edit-btn" />
                </div>
            </div>
        </div>
    </div>
