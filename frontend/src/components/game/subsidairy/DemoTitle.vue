...
const nextScene = () => {
    emit('next-scene', {
        targetSceneId: store.state.game.currentScene.data.nextSceneId
    });
};
</script>
...
<template>
    <div class="titles-container" @click="nextScene" >
        ...
        <p class="line-anim delay-3">De instorting van ecosystemen in het midden van de jaren 2020 leidde tot de opkomst van industrieel Wander Mallace, wiens beheersing van synthetische landbouw een wereldwijde hongersnood voorkwam.</p>
